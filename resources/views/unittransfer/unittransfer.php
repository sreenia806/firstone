...
<div class="content-header row">
    <div class="content-header-left col-md-6 col-12 mb-2">
        <h3 class="content-header-title mb-0 d-inline-block">Add Unit transfer</h3>
    </div>
</div>

<form class="form form-horizontal" action="{{ route('unittransfers.store') }}" method="POST">
    {{ csrf_field() }}
    <div class="form-body">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group row">
                    <label class="col-md-3 label-control" for="select_employee">Fist
                        Name</label>
                    <div class="col-md-9">
