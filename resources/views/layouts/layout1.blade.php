        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    <span class="user-name text-bold-700" style="padding-left: 20px"><a href="">Logout</a></span>
                </ul>
            </div>
        </div>
    </div>
...
<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class=" nav-item"><a href="index.html"><i class="la la-bell-o"></i><span class="menu-title"
                ...
                <ul class="menu-content">
                    ...
                    <li><a class="menu-item" href="dashboard-sales.html"
            ...
            <li class=" nav-item"><a href="#"><i class="la la-television"></i><span class="menu-title"
                ...
                <ul class="menu-content">
                    <li><a class="menu-item" href="#" data-i18n="nav.templates.vert.main">Vertical</a>
                        <ul class="menu-content">
                            <li class="active"><a class="menu-item" href="../vertical-menu-template"
                                   data-i18n="nav.templates.vert.classic_menu">Employee Details</a>
                                <ul class="menu-content">
                                    <li><a class="menu-item" href="../employees/create">Create Employee</a>
                                </ul>
                            </li>
